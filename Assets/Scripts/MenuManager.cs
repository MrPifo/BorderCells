...
public class MenuManager : MonoBehaviour {
	...
	public void LoadAndDisplayAllLevelMap() {
		...
		foreach(TextAsset file in Resources.LoadAll<TextAsset>("Levels/")) {
			...
			obj.GetChild(1).GetComponent<Image>().sprite = map.completionStars[0].completed ? filledStar : emptyStar;
			obj.GetChild(2).GetComponent<Image>().sprite = map.completionStars[1].completed ? filledStar : emptyStar;
			obj.GetChild(3).GetComponent<Image>().sprite = map.completionStars[2].completed ? filledStar : emptyStar;
